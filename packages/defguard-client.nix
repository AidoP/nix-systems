...
#         hash = "sha256-5c2b106cc43824d9df0d651b66710691e06e6d75ef7dce8a85e1ccdc3ad20620";
#     };
#
#     cargoHash = "...";
#
...
rustPlatform.buildRustPackage rec {
    ...
    postInstall =
      ...
      desktop-file-edit \
        ...
        --set-key="StartupWMClass" --set-value="DefGuard" \
        $out/share/applications/DefGuard.desktop
        '';
    ...
    meta = {
        description = "Enterprise VPN with full control and transparency";
        homepage = "https://defguard.net";
        changelog = "https://github.com/DefGuard/client/releases/tag/release/${version}";
